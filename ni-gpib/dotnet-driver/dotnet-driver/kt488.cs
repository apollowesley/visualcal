// --------------------------------------------------------------------------------
//  C# implementation of the Keysight 488 API definitions.  Use this file with the
//  C# language to program GPIB I/O interfaces that support the Keysight 488 (or
//  National Instruments NI-488.2) I/O API, such as Keysight 82357A USB/GPIB 
//  converter or Keysight 82350B PCI GPIB card.  See the Keysight IO Libraries Suite 
//  documentation for more information on programming with Keysight 488.
//
//  Copyright (C) 2005 Keysight Technologies, Inc.
// --------------------------------------------------------------------------------
//  Title   : ag488.cs
//  Date    : 07-13-2005
//  Purpose : Keysight 488 definitions for C#
// -------------------------------------------------------------------------
using System;
using System.Text;
...
namespace Keysight.TMFramework.Connectivity
{
  public delegate int GpibNotifyCallback_t(int localUd, int localIbsta, int localIberr, int localIbcntl, IntPtr refData);

  /// <summary>
  /// This class contains the definitions for the Keysight 488 functions and constant values
  /// for use in C#.
  /// </summary>

  public class Kt488Wrap
  {
    ...
    /*  Keysight 488 Function Prototypes  */
    ...
    /// <summary>
    /// Use 7 or 8-bit EOS compare: Only 8-bit compare is supported for Keysight interfaces
    /// </summary>
    ...
    /// <summary>
    /// Length of cable specified for high speed timing: Not supported for Keysight interfaces
    /// </summary>
    ...
    ///		0x10	Use 8-bit EOS comparison (the fixed default for Keysight interfaces)
    ...
    /// </summary>
    /// <param name="ud">Board (interface) descriptor</param>
    /// <param name="v">Nonzero to perform acceptor handshaking (ignored by Keysight interfaces)</param>
    /// <returns>Status outcome</returns>
    ...
    /// </summary>
    /// <param name="ud">Device or board descriptor (Keysight interfaces support only device-level)</param>
    /// <returns>Status outcome</returns>
    ...
    /// <returns>Status outcome</returns>
    /// <remarks>
    /// Keysight interfaces do not support changing this status.
    ...
    /// <returns>Status outcome</returns>
    /// <remarks>
    /// Keysight interfaces don't support secondary addresses for themselves.
    /// Keysight Connection Expert displays device secondary addresses as 0 to 30.
    /// Add 96 to that value to get the equivalent Keysight 488 secondary address.
    /// </remarks>
    ...
    /**************************************************************************/
    /*  Keysight 488 Extended Function Prototypes  */
